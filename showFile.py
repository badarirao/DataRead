...
class Ui_Plotter(object):
    def setupUi(self, Plotter):
        ...
        self.commentsBox.setMaximumSize(QtCore.QSize(16777215, 210))
        ...
        self.metaDataFixed.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.metaDataComments.setMaximumSize(QtCore.QSize(16777215, 100))
        ...
        self.plotTree.setMinimumSize(QtCore.QSize(200, 500))
        ...
        self.toolBarWidget.setMaximumSize(QtCore.QSize(50, 16777215))
        ...
        self.action_createh5 = QtWidgets.QAction(Plotter)
        self.action_createh5.setObjectName("action_createh5")
        ...
        self.menuFile.addAction(self.action_createh5)
        self.menuFile.addSeparator()
    ...
    def retranslateUi(self, Plotter):
        ...
        self.action_createh5.setText(_translate("Plotter", "Merge all data into H5"))
